...
{	
	public static MD2Mesh load( GL10 gl, InputStream in )
	{
		try
		{
			...
			return buildMesh( gl, header, triangles, texCoords, frames );
		}
		catch( Exception ex )
		{
			ex.printStackTrace();
	...
	private static MD2Mesh buildMesh( GL10 gl, MD2Header header, MD2Triangle[] triangles, float[] texCoords, MD2Frame[] frames )
	{
		...
		return new MD2Mesh( gl, frames, indices, uvs, null );
	}
